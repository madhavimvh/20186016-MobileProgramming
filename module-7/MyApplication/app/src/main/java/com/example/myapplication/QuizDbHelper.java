...
public class QuizDbHelper extends SQLiteOpenHelper {
    ...
    private void fillQuestionsTable() {
        ...
        addQuestion(q8);
        Question q9 = new Question("Which one of the following in place sorting algorithms needs the minimum number of swaps?", "Quick sort", "merge sort", "Selection sort", 3);
        addQuestion(q9);
